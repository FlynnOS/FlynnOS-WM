 ...
 *
 */
#ifndef KEYRELEASEHANDLER_H
#define KEYRELEASEHANDLER_H
 ...
 */
class KeyReleaseHandler : public EventHandler {
    ...
    public:
         ...
         */
        KeyReleaseHandler(XWindowList* wl);
