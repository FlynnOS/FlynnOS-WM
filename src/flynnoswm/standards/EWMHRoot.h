...
class EWMHRoot {
    ...
    public:
        ...
        /**
         * @~spanish
         * Envía a la ventana raíz los hints que soporta FlynnOSwm.
         *
         * @~english
         * TO TRANSLATE
         */
         ...
         * ejecutándose, FlynnOSwm envía a la ventana raíz el ID de una ventana
         * creada por él (clase WMCheckWindow).
         * Dicha ventana tiene que tener como _NET_WM_NAME "Flynn OS WM"
         ...
         * @param wl Lista con todas las ventanas gestionadas o no por FlynnOSwm.
